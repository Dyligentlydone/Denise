        ...
        <div className="bg-white p-6 md:p-8 rounded-lg shadow-md">
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Please refer to our <a href="/privacy" className="text-sage-600 hover:underline">Privacy Policy</a> and <a href="/terms" className="text-sage-600 hover:underline">Terms of Service</a> for more information.
            </p>
          </section>
